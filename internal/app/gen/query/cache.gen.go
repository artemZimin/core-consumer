...
func newCache(db *gorm.DB, opts ...gen.DOOption) cache {
	...
	_cache.cacheDo.UseModel(&model.Cache{})
...
func (c cacheDo) Create(values ...*model.Cache) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cacheDo) CreateInBatches(values []*model.Cache, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cacheDo) Save(values ...*model.Cache) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cacheDo) First() (*model.Cache, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.Cache), nil
	}
}

func (c cacheDo) Take() (*model.Cache, error) {
...
func (c cacheDo) Last() (*model.Cache, error) {
...
func (c cacheDo) Find() ([]*model.Cache, error) {
	result, err := c.DO.Find()
	return result.([]*model.Cache), err
}

func (c cacheDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Cache, err error) {
	buf := make([]*model.Cache, 0, batchSize)
...
func (c cacheDo) FindInBatches(result *[]*model.Cache, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cacheDo) FirstOrInit() (*model.Cache, error) {
...
func (c cacheDo) FirstOrCreate() (*model.Cache, error) {
...
func (c cacheDo) FindByPage(offset int, limit int) (result []*model.Cache, count int64, err error) {
...
func (c cacheDo) Delete(models ...*model.Cache) (result gen.ResultInfo, err error) {
