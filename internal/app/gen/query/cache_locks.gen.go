...
func newCacheLock(db *gorm.DB, opts ...gen.DOOption) cacheLock {
	...
	_cacheLock.cacheLockDo.UseModel(&model.CacheLock{})
...
func (c cacheLockDo) Create(values ...*model.CacheLock) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cacheLockDo) CreateInBatches(values []*model.CacheLock, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cacheLockDo) Save(values ...*model.CacheLock) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cacheLockDo) First() (*model.CacheLock, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.CacheLock), nil
	}
}

func (c cacheLockDo) Take() (*model.CacheLock, error) {
...
func (c cacheLockDo) Last() (*model.CacheLock, error) {
...
func (c cacheLockDo) Find() ([]*model.CacheLock, error) {
	result, err := c.DO.Find()
	return result.([]*model.CacheLock), err
}

func (c cacheLockDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.CacheLock, err error) {
	buf := make([]*model.CacheLock, 0, batchSize)
...
func (c cacheLockDo) FindInBatches(result *[]*model.CacheLock, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cacheLockDo) FirstOrInit() (*model.CacheLock, error) {
...
func (c cacheLockDo) FirstOrCreate() (*model.CacheLock, error) {
...
func (c cacheLockDo) FindByPage(offset int, limit int) (result []*model.CacheLock, count int64, err error) {
...
func (c cacheLockDo) Delete(models ...*model.CacheLock) (result gen.ResultInfo, err error) {
