...
func newJobBatch(db *gorm.DB, opts ...gen.DOOption) jobBatch {
	...
	_jobBatch.jobBatchDo.UseModel(&model.JobBatch{})
...
func (j jobBatchDo) Create(values ...*model.JobBatch) error {
	if len(values) == 0 {
		return nil
	}
...
func (j jobBatchDo) CreateInBatches(values []*model.JobBatch, batchSize int) error {
	return j.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (j jobBatchDo) Save(values ...*model.JobBatch) error {
	if len(values) == 0 {
		return nil
	}
...
func (j jobBatchDo) First() (*model.JobBatch, error) {
	if result, err := j.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.JobBatch), nil
	}
}

func (j jobBatchDo) Take() (*model.JobBatch, error) {
...
func (j jobBatchDo) Last() (*model.JobBatch, error) {
...
func (j jobBatchDo) Find() ([]*model.JobBatch, error) {
	result, err := j.DO.Find()
	return result.([]*model.JobBatch), err
}

func (j jobBatchDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.JobBatch, err error) {
	buf := make([]*model.JobBatch, 0, batchSize)
...
func (j jobBatchDo) FindInBatches(result *[]*model.JobBatch, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (j jobBatchDo) FirstOrInit() (*model.JobBatch, error) {
...
func (j jobBatchDo) FirstOrCreate() (*model.JobBatch, error) {
...
func (j jobBatchDo) FindByPage(offset int, limit int) (result []*model.JobBatch, count int64, err error) {
...
func (j jobBatchDo) Delete(models ...*model.JobBatch) (result gen.ResultInfo, err error) {
